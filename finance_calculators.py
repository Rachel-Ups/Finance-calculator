# Capstone Project
# This program will allow users to access either an investment calculator or a home loan repayment calculator.
# Include definitions for user to see for bond and investment
# First step the user to input which calculator they would like to use.
...
which_calculator = str(input("Enter either 'investment' or 'bond' from the menu above to proceed: "))
...
if which_calculator_lower == investment:
    ...
    interest = input("Please enter whether you would like 'simple' or 'compound': ")
    if interest == simple:
        print("The total amount you will get back after the given period for simple interest is: £", (float(money*(1+r*number_years))), "Thank you.")
    elif interest == compound:
        print("The total amount you will get back after the given period for compound interest is: £", (float(money*(1+r)**number_years)), "Thank you.")
    else:
        print("Please type in 'simple' or 'compound'. Thanks.")
